    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('admin.subcategories')}}">SubCategory</a></li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="post">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{ route('index.post') }}"> All Posts </a></li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="setting">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('social.setting')}}"> Socials Setting </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('seo.setting')}}"> Seos Setting </a></li>
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('notice.setting')}}"> Notices Setting </a></li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="website">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('add.website')}}"> Add Websites </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('website.index')}}"> All Websites </a></li>      </li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="photo">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{route('video.gallery')}}"> Video Gallery </a></li>      </li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ads">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('ads_list')}}">Ads list</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{route('add.ads')}}"> Ads Add </a></li>      </li>
          </ul>
        </div>
      </li>
      @else
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{route('list.writer')}}"> All Writer </a></li>
